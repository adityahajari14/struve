    ...
    <main className="w-full pt-24">
      ...
      <section className="w-full bg-white">
        <div className="grid grid-cols-2 w-full">
          {/* Left Column - Image */}
          <div className="flex items-center justify-center overflow-hidden h-[704px]">
            <Image 
              src="/home1.webp" 
          ...
          <div className="flex flex-col justify-center px-16 py-20">
            <div className="mb-12">
              <h1 className="text-5xl font-bold leading-tight mb-4">
                ...
                <br />
                <span className="text-[1.55rem] font-bold text-[#444444]">Structural Value Engineering</span>
              </h1>
            </div>
      ...
      <section className="w-full bg-white">
        <div className="grid grid-cols-2 gap-0 w-full">
          {/* Left Column - Content */}
          <div className="flex flex-col px-16 py-20 space-y-16 justify-center">
            {/* What Is Value Engineering */}
            <div>
              <h2 className="text-xl font-bold text-[#444444] mb-10 leading-tight">
                What Is<br />
                Value Engineering?
              </h2>
              <p className="text-base text-justify leading-relaxed text-[#444444]">
          ...
          {/* Right Column - Image */}
          <div className="flex items-start justify-center overflow-hidden h-[631px]">
            <Image 
              src="/home1.webp" 
